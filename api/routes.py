...
def auth():
    ...
    if "code" in args:
        code = args['code']
        return requests.get('https://oauth.vk.com/access_token?client_id=8012324&client_secret=COH80Oy3E72Nhj7ChB7L&redirect_uri=http://test.api.wan-group.ru/auth&code='+code).content
    else:
